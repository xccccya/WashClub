<template>
	<view class="page">
		<view class="map"><RideMap v-if="trip" :markers="markers" :route-points="routePoints" :fit-padding="mapFitPadding" :locate-bottom="locateBottom" /></view>
...
const locateBottom = computed(() => detailCollapsed.value ? '190rpx' : 'calc(70vh + 28rpx)');
...
.drawer{right:20rpx;width:auto;max-width:none;overflow:hidden}
