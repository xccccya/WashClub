...
const trip = ref<any>(null); const chat = ref(false); const vehicleLogoFailed = ref(false); const fareExpanded = ref(false); let id = 0; const isDriverView = ref(false); let stopRealtime: (() => void) | null = null; let poll: ReturnType<typeof setInterval> | undefined;
