<template>
	<view v-if="modelValue" class="mask" @tap.self="close">
		<view class="sheet">
			<view class="handle" />
...
<style scoped>
.mask{position:fixed;z-index:100;inset:0;display:flex;align-items:flex-end;background:rgba(15,23,42,.45);backdrop-filter:blur(5px)}.sheet{width:100%;height:72vh;padding:14rpx 24rpx calc(22rpx + env(safe-area-inset-bottom));border-radius:36rpx 36rpx 0 0;background:linear-gradient(180deg,#fff,#f8fafc);box-shadow:0 -18rpx 60rpx rgba(15,23,42,.2);box-sizing:border-box}.handle{width:72rpx;height:8rpx;margin:0 auto 18rpx;border-radius:999rpx;background:#cbd5e1}.head,.send{display:flex;align-items:center}.head{justify-content:space-between;padding-bottom:18rpx;border-bottom:1rpx solid #e2e8f0}.head strong,.head text{display:block}.head strong{color:#0f172a;font-size:30rpx}.head view text{margin-top:4rpx;color:#94a3b8;font-size:20rpx}.close{padding:10rpx;color:#2563eb;font-size:23rpx}.messages{height:calc(72vh - 190rpx);padding:18rpx 0;box-sizing:border-box}.state{padding:80rpx 20rpx;color:#94a3b8;text-align:center;font-size:23rpx}.state strong,.state text{display:block}.state strong{color:#475569;font-size:28rpx}.state text{margin-top:8rpx}.message-row{display:flex;flex-direction:column;align-items:flex-start;margin:14rpx 0}.message-row.mine{align-items:flex-end}.sender{margin:0 8rpx 6rpx;color:#94a3b8;font-size:19rpx}.bubble{max-width:76%;padding:15rpx 19rpx;border-radius:8rpx 22rpx 22rpx;background:#fff;border:1rpx solid #e2e8f0;box-shadow:0 5rpx 16rpx rgba(15,23,42,.06);color:#334155;font-size:25rpx;line-height:1.55;word-break:break-all}.mine .bubble{border-color:#2563eb;border-radius:22rpx 8rpx 22rpx 22rpx;background:linear-gradient(135deg,#3580ff,#2563eb);color:#fff}.send{gap:12rpx;padding-top:14rpx;border-top:1rpx solid #e2e8f0}.send input{min-width:0;flex:1;padding:16rpx 20rpx;border-radius:999rpx;background:#eef2f7;color:#0f172a;font-size:24rpx}.send button{flex:none;margin:0;padding:0 25rpx;border-radius:999rpx;background:#2563eb;color:#fff;font-size:23rpx}.send button[disabled]{background:#cbd5e1;color:#fff}
</style>
