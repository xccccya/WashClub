...
@Module({
	...
	providers: [AuthService, AdminRoleService, SmsService, AdminGuard, AdminOrEmployeeGuard, WechatTokenService],
	exports: [AdminGuard, AdminOrEmployeeGuard, JwtModule, WechatTokenService],
})
