...
-- AlterTable
ALTER TABLE `servicequeueitem` ADD COLUMN `currentTaskIndex` INTEGER NOT NULL DEFAULT -1,
    ADD COLUMN `finishedAt` DATETIME(3) NULL,
    ADD COLUMN `orderSort` INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN `startedAt` DATETIME(3) NULL,
    ADD COLUMN `status` ENUM('IN_QUEUE', 'SERVING', 'COMPLETED') NOT NULL DEFAULT 'IN_QUEUE';
