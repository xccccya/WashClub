/*
  ...
  - You are about to drop the column `currentTaskIndex` on the `servicequeueitem` table. All the data in the column will be lost.
  - You are about to drop the column `finishedAt` on the `servicequeueitem` table. All the data in the column will be lost.
  - You are about to drop the column `orderSort` on the `servicequeueitem` table. All the data in the column will be lost.
  - You are about to drop the column `startedAt` on the `servicequeueitem` table. All the data in the column will be lost.
  - You are about to drop the column `status` on the `servicequeueitem` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `servicequeueitem` DROP COLUMN `currentTaskIndex`,
    DROP COLUMN `finishedAt`,
    DROP COLUMN `orderSort`,
